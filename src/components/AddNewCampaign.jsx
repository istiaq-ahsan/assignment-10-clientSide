...
const AddNewCampaign = () => {
  ...
  const handleAddProject = (e) => {
    ...
    const amount = parseInt(e.target.donationAmount.value);
      ...
      <div className="w-11/12 md:w-4/5 mx-auto">
        <div className="text-center text-gray-900">
          ...
          <p className="text-base my-5">
            Create your crowdfunding campaign and share your vision with the
            world. Provide essential details to help backers understand and
            support your project or cause.
          </p>
        </div>
