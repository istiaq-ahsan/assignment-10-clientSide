...
const UpdateCampaign = () => {
    ...
    const { _id, name, email, title, type, amount, date, description, photo } = loadedAllInfo;
                ...
                <form onSubmit={handleUpdateProject} className="card-body">
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        <div className="form-control flex-1">
                            ...
                            <input type="number" name='donationAmount' placeholder="amount" defaultValue={amount}
                                className="input input-bordered" required />
                        </div>
                        ...
                        <div className="form-control flex-1">
                            ...
                            <input type="date" name='deadline' placeholder="Date" defaultValue={date}
                                className="input input-bordered" required />
                        </div>
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name='photo' placeholder="Photo url" defaultValue={photo}
                            className="input input-bordered" required />
