...
const Footer = () => {
    return (
        <div className="footer bg-gray-900 text-white p-10 grid grid-cols-1 md:grid-cols-7 justify-around items-center">
            <div className="md:col-span-3 space-y-3">
                <div className="bg-gray-200 rounded-full p-3">
                    <img className="w-10 h-10" src="/kindness.png" alt="" />
                </div>
                <h2 className="text-4xl font-bold">Crowdcube</h2>
                <p className="text-base">Always ready to be your friend. Come & Contact with us to share your memorable moments, to share with your best companion.</p>
