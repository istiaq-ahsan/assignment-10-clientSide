        ...
        <div className="bg-gray-200 pt-10 pb-20">
            <div className="w-11/12 mx-auto justify-center items-center">
                <div className="text-center">
                    ...
                    <p className="text-base my-10 w-4/5 mx-auto">Discover inspiring projects and causes that are currently
                        seeking support. Join hands with passionate creators,
                        innovators, and changemakers by contributing to their
                        campaigns. Your support can help bring these ideas to
                        life and make a meaningful difference!
                    </p>
                </div>
                <div className=" flex overflow-x-auto gap-5 px-2">
                    {
                        allCampaign.map((singleCampaign) => <RunningProjectCard
